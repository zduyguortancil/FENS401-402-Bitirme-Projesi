...
# Event label -> display name + impact direction
EVENT_META = {
    "flight disruption":        {"tr": "Flight Disruption",       "impact": -1,   "icon": "✈️⚠️"},
    "strike or labor dispute":  {"tr": "Strike / Labor Dispute",  "impact": -1,  "icon": "✊"},
    "weather disruption":       {"tr": "Weather Disruption",      "impact": -1,  "icon": "🌩️"},
    "security threat":          {"tr": "Security Threat",         "impact": -1,  "icon": "🚨"},
    "tourism growth":           {"tr": "Tourism Growth",          "impact": +1,  "icon": "📈"},
    "new route or airline expansion": {"tr": "New Route / Expansion","impact": +1,"icon": "🚀"},
    "airport congestion":       {"tr": "Airport Congestion",      "impact": -0.5,"icon": "🔴"},
    "general travel news":      {"tr": "General Travel News",     "impact": 0,   "icon": "📰"},
}
...
def _empty_aggregate() -> dict:
    return {
        ...
        "dominant_event_tr": "General Travel News",
        "article_count": 0,
        "positive_count": 0,
        "negative_count": 0,
        "neutral_count": 0,
